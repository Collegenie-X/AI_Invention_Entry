<!-- Gamma 붙여넣기용 · 2일차 1교시 「아이디어는 어떻게 커지는가」 · 총 65장
     설계서: (2일차-1교시)-PPT_감마_슬라이드설계.md
     사용법: Gamma → 새로 만들기 → 텍스트 붙여넣기 → 텍스트 처리 "유지(Preserve)" → 카드 나누기 "---" -->
...
|---|---|---|
| 🤖 **AI**<br/>*자동으로 채운다* | **"여기서 손이 제일 오래 걸리는 곳은 어디야?"** | 카드 글·그림 초안을 AI가 생성 (**맨 마지막에**) |
| 🛠 **메이커**<br/>*내가 만들어 쓴다* | **"우리가 넣은 내용이 떨어지면 사용자가 채울 수 있어?"** | 내 사진·그림·별명으로 카드 ("뿜뿜 아빠") |
| 🤝 **커뮤니티**<br/>*주고받는다* | **"혼자 쓰는 것보다 둘이 쓰면 좋아지는 지점이 있어?"** | 단어장 파일 내보내기, 우수작은 공식 템플릿 |
...
| 축 | 던지는 질문 | 링고팡의 답 |
|---|---|---|
| ⚙️ **기능 확대**<br/>*(기능 개수 ❌)* | **"같은 걸 또 하고 싶게 하려면 어떤 다른 모습이 필요해?"** | 받아쓰기 하나 → **8가지 게임** (5일 사이클) |
